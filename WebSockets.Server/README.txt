...
If you want to skip past all the plumbing then another good place to start is the Respond function in the WebSocketConnection class
If you are not interested in the inner workings of Web Sockets and just want to use them then take a look at the OnTextFrame in the ChatWebSocketConnection class
...
eg: 
GET /chat HTTP/1.1
This folder has been setup to use the ChatWebSocketConnection class